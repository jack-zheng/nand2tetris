...
public class CodeWriter {
    ...
    public CodeWriter(File output) throws Exception {
    ...
    public void writeArithmethic(String cmd) throws IOException {
        ...
        ariths.forEach(System.out::println);
    ...
    private void logWarning(String comment) throws IOException {
    ...
    public void writeGoto(String label) throws IOException {
        String cmd1 = "// goto " + label + "\n";
        String cmd2 = "@" + functionName + "$" + label + "\n";
        String cmd3 = "0;JMP" + "\n";
    ...
    public void writeCall(String functionName, int numArgs) throws IOException {
        ...
        String returnAddr = functionName + "$ret." + returnCounter++;
        myWriter.write("@" + returnAddr + "\n");
        myWriter.write("D=A\n");
        myWriter.write("@SP\n");
        myWriter.write("A=M\n");
        myWriter.write("M=D\n"); // 将 retAdd 的值存到 SP 所指的位置, 这里的 retAdd 是一个 label
        myWriter.write("@SP\n");
    ...
    public void writeFunction(String functionName, int numLocals) throws IOException {
        String comment = "// function " + functionName + " " + numLocals + "\n";
        System.out.print(comment);
        myWriter.write(comment);

        this.functionName = functionName;
        String funcLabel = "(" + functionName + ")\n";
        System.out.print(funcLabel);
        myWriter.write(funcLabel);
